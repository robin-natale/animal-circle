...
export const siteConfig: SiteConfig = {
  ...
  url: "https://animalcircle.org",
  name: "Animal Circle",
  description:
    "Animal communication, energetic support, and welfare advocacy for animals in sanctuaries, rescues, and animal centres.",
  author: "Animal Circle",
  email: "hello@animalcircle.org",
  ...
  socialLinks: [
    ...
    { platform: "email", url: "mailto:hello@animalcircle.org", label: "Email" },
  ],
